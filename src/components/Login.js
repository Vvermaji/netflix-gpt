 ...
 setIsSignIn(!isSignInForm);
  ...
  return (
    <div>
      ...
      {!isSignInForm && <input 
        typeof='text' placeholder='Full Name' className='p-4 my-4 w-full bg-gray-700 ' />}
        <input typeof='text' placeholder='Email Address' className='p-4 my-4 w-full bg-gray-700' />
        <input typeof='password' placeholder='Password' className='p-4 my-4 w-full bg-gray-700 ' />
